...
// Fixed leadership display order. Members are always shown
// in this order, regardless of when they were added.
...
function getPositionOrder(position) {
    return POSITION_ORDER[String(position || "").trim()] ?? 999;
}

function sortMembersByPosition(data) {
    return data.sort((a, b) => {
        ...
        // Same position: keep a stable, predictable alphabetical order.
